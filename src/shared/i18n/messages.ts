...
export const MESSAGES: Record<Locale, Record<MessageKey, string>> = {
  es: {
    ...
    'stage.roundOf32': '32avos',
    'stage.roundOf16': '16avos',
    'stage.quarterFinal': 'Cuartos',
    ...
    'nav.openBracket': 'Ver cuadro final',
    'nav.backToMain': 'Volver al inicio',
    'bracket.page.title': 'Cuadro final',
    'bracket.page.subtitle': 'Cruces y camino al título del Mundial 2026',
    'bracket.print.cta': 'Imprimir cuadro',
    'bracket.stage.roundOf32': '32avos',
    'bracket.stage.roundOf16': '16avos',
    'bracket.stage.quarterFinal': 'Cuartos de final',
    'bracket.stage.semiFinal': 'Semifinales',
    'bracket.stage.thirdPlace': 'Tercer puesto',
    'bracket.stage.final': 'Final',
    'bracket.empty.title': 'El cuadro todavía no está disponible',
    'bracket.empty.body':
      'Volvé más tarde cuando estén cargados los cruces de eliminación directa.',
    'bracket.error.title': 'No se pudo cargar el cuadro',
    'bracket.error.body': 'Probá de nuevo en un rato.',
    ...
    'data.fresh': 'Datos en línea',
    'data.stale.history': 'Datos guardados (sin conexión reciente)',
    'data.stale.fixture': 'Datos de respaldo (sin conexión)',
  ...
  en: {
    ...
    'nav.openBracket': 'View bracket',
    'nav.backToMain': 'Back to main',
    'bracket.page.title': 'Knockout bracket',
    'bracket.page.subtitle': 'Every path to the 2026 World Cup title',
    'bracket.print.cta': 'Print bracket',
    'bracket.stage.roundOf32': 'Round of 32',
    'bracket.stage.roundOf16': 'Round of 16',
    'bracket.stage.quarterFinal': 'Quarter-finals',
    'bracket.stage.semiFinal': 'Semi-finals',
    'bracket.stage.thirdPlace': 'Third place',
    'bracket.stage.final': 'Final',
    'bracket.empty.title': 'The bracket is not available yet',
    'bracket.empty.body': 'Check back later once the knockout fixtures are available.',
    'bracket.error.title': "Couldn't load the bracket",
    'bracket.error.body': 'Please try again in a bit.',
    ...
    'data.fresh': 'Live data',
    'data.stale.history': 'Saved data (no recent connection)',
    'data.stale.fixture': 'Fallback data (offline)',
